 ...
 ******************************************************************************/
/**
 * @brief The handler for the robot's actuators, which in derived from motion_handler base class
...
class RobotMotionHandler : public MotionHandler {
  ...
  *
  */
  void UpdateVelocity(SensorTouch st, SensorEntityType se, SensorProximity sp,
     SensorDistress sd);
  /**
  * @brief Change the speed and direction according to the sensor readings.
  *
