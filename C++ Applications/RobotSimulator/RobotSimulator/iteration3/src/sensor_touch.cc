 ...
 * Member Functions
 ******************************************************************************/
//  void SensorTouch::CheckForEntityOutOfBounds(const
...
//      event->set_point_of_contact(Position(static_cast<int>(ent->get_pos().x),
//      static_cast<int>(ent->get_pos().y)));
...
//   EventCollision * event, double collision_delta) {
...
//      // Point of cantact
//      event->set_point_of_contact(Position(static_cast<int>(ent1_x),
//       static_cast<int>(ent1_y)));
//      event->set_angle_of_contact((180 - 2*Ang_contact +
//        ((reinterpret_cast<ArenaMobileEntity*>(ent1))->get_heading_angle())));
//      event->set_collided(true);
//     }
