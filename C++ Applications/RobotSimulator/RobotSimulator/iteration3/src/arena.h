...
class Arena {
  ...
  */
  ...
  /**
  * @brief Ret entities into original state
  *
  *
  */
  void Reset(void);
  ...
  /**
   * @brief Get a list of all robots (i.e. non-mobile entities in the arena).
   */
 ...
 */
  void registerRobot(Robot *observer);

 /**
 * Unregister an observer
 * @param observer the observer object to be unregistered
 */
  void removeRobot(Robot *observer);
