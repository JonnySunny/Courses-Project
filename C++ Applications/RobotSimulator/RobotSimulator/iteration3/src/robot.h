...
class Robot : public ArenaMobileEntity {
 public:
  ...
  /**
   * @brief Get the state of the current sensor_proximity_ to see if it has been activated
   *
   * @return state_proximity_ int
   */
  ...
  /**
   * @brief Get the state of the current sensor_distress_ to see if it has been activated
   *
   * @return state_distress_ int
   */
  ...
  /**
   * @brief Get the field of view of the current sensor_proximity_
   *
   * @return sensor_proximity_.get_fov() int
   */
  double get_fov() {
