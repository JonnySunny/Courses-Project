...
/**
    @brief STV class. Uses a droop quota to determine winners. Makes a winners and losers list after iterating through the candidates list. Sorts every candidate into one of the two lists depending on if they made the quota or not.
*/
 ...
 private:
    ...
    */
    ...
    /**
        ...
        @param[in] The vector of ballots to iterate through
    */
